...
Run from platform/executive-daemon/:
  PYTHONPATH=src python3 -m pytest tests/test_project_store.py -q
"""
...
# We need to override the store paths to use temp dirs for all tests.
# Each store accepts an optional base_dir argument — we pass tmp_path.
